...
import { lucideArrowLeft, lucideCloudDownload, lucideLoader, lucideTrash } from '@ng-icons/lucide';
...
@Component({
  ...
  providers: [provideIcons({ lucideArrowLeft, lucideCloudDownload, lucideTrash, lucideLoader })],
})
