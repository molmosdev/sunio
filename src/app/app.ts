...
@Component({
  ...
  template: `
    <header
      class="flex justify-center items-center h-22 fixed top-0 left-0 w-full bg-linear-to-b from-background dark:from-background-dark to-transparent z-10 transition-colors duration-150"
    >
      <svg
        class="outline-none"
        width="30"
    ...
    <s-dynamic-drawer />
    <div
      class="flex bg-linear-to-t from-background dark:from-background-dark to-transparent fixed bottom-0 left-0 h-22 w-full transition-colors duration-150'"
    ></div>
  `,
  host: {
